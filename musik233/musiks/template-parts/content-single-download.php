					    ...
					    <div class="row">
							...
							<div class="col-sm-8">
								...
								<div class="m-b-lg clearfix">
							        ...
							        if($download && ( is_user_logged_in() == false && get_theme_mod('hide-download') == "1" ) == false ){
							            $preview = get_preview($post->ID);
							          ?>
							          <a href="<?php echo admin_url('admin-ajax.php').'?action=download&file='.esc_url( reset($preview) ); ?>" class="btn pull-left btn-download m-r <?php echo get_theme_mod( 'btn-bg-color' ); ?>">
